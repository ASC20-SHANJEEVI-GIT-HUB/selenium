...
public class Lab9 extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        System.out.println("Browser open and navigate to site.");
    }
    ...
    public void testLab3BasicFlow() throws Exception {
        ...
        System.out.println("Verify success message for iMac.");
    }
    ...
    public void testLab4ValidationFlow() throws Exception {
        ...
        System.out.println("Verify page heading as 'Mac'.");
        ...
        System.out.println("iMac added to cart verify.");
        ...
        System.out.println("Verify search results for 'Monitors'.");
    }
}
